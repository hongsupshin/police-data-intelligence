...
class Settings(BaseSettings):
    ...
    Attributes:
        ...
        enable_conflict_annotation: Feature flag for the advisory LLM
            ...
            Read by the synthesize node (any dataset); on by default
            (earn-confirmed 2026-06-13: offline Haiku sample of 30 deep-conflict
            records was faithful + useful, zero harmful notes; set
            ``ENRICHMENT_ENABLE_CONFLICT_ANNOTATION=false`` to disable).
    """
    ...
    enable_conflict_annotation: bool = True
